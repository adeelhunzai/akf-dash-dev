...
export default function ManagerSettingsContent() {
  const { toast } = useToast();
  const dispatch = useAppDispatch();
  const fileInputRef = useRef<HTMLInputElement>(null);
  // Reusing facilitator settings API as settings are user-level
    ...
    <div className="p-8">
      ...
      <div className="bg-white rounded-md border border-gray-200 p-6">
        ...
        <div className="border-b border-gray-100 mb-6">
          <button className="pb-3 px-1 text-[#00B140] font-medium border-b-2 border-[#00B140] flex items-center gap-2">
        ...
        <div className="mb-8">
          ...
          <div>
            <Label htmlFor="bio" className="text-sm text-gray-500 font-normal mb-1.5 block">
              Bio / About (Optional)
            </Label>
            <Textarea
              id="bio"
